...
// ----------------------------------------------
// STATIC + MEMOIZED CARD DATA (Prevents Re-renders)
// ----------------------------------------------
const CARD_DATA = [
  {
...
// OPTIMIZED COMPONENT
// ----------------------------------------------
function WhyChooseObsio({ highlightColor }) {
  return (
    <section className="w-full max-w-6xl mx-auto px-4 py-20 font-jura text-center my-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {CARD_DATA.map(({ title, description, Icon, bg }, index) => (
          <article
            key={index}
            className={`group relative block rounded-xl border border-gray-700 ${bg}
...
export default memo(WhyChooseObsio);
